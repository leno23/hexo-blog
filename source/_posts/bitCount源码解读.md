...
首先，我们知道32位无符号整数占4个字节 一个字节有8个二进制位,1最多的数(注意：不是最大的数)是0xffffffff，其中的一个f代表一段4个为1的二进制位 写成二进制的话也就是 *11111111 11111111 11111111 11111111*，其实它就是-1了。
...
这样一来，我们就将二位的二进制串中高位1的个数 算出来放到这两个二进制位上，
